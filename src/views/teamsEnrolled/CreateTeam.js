...
import { Button, DialogActions, DialogContent, DialogTitle, Divider, Grid, Paper, TextField, Tooltip, Typography } from '@mui/material'
...
const CreateTeam = (props) => {
  ...
  const loadData = (searchString) => {
    ...
    //  let myURL = `/v1/tournament/registeredplayerbytournament?TournamentID=${TournamentID}&CategoryID=${CategoryID}&Status=${values.Status}`;
    ...
    <>
      ...
      <DialogContent>
        ...
        <Grid container spacing={2} paddingTop={2}>
          <Grid item xs={4}>
            <SearchComponent callfunction={loadData} />
          </Grid>
          <Grid item xs={5}>
